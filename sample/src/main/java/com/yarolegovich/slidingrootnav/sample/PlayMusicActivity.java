...
import com.yarolegovich.slidingrootnav.sample.utils.ConstantUtils;
import com.yarolegovich.slidingrootnav.sample.utils.MusicUtils;
import com.yarolegovich.slidingrootnav.sample.view.AvatarCircle;
...
public class PlayMusicActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (mServiceMsger != null) {
                Toast.makeText(PlayMusicActivity.this, "远程服务连接成功", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(PlayMusicActivity.this, "远程服务连接失败", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    protected void onDestroy() {
        ...
        Log.i("Test", "PlayMusicActivity onDestroy");
    }


    private void serviceInit() {
        mMusicSeviceIntent = new Intent();
        mMusicSeviceIntent.setClass(PlayMusicActivity.this, PlayMusicActivity.class);
